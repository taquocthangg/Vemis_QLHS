...
public partial class VwHienTaiHanhKiemH
{
    ...
    public string? MaNamHocHanhKiemTieuHoc { get; set; }

    public string? HanhKiemTieuHoc { get; set; }

    public string? MaHocKyHanhKiemTieuHoc { get; set; }

    public string? MaHanhKiemTieuHoc { get; set; }

    public string? HocLucTieuHoc { get; set; }

    public string? MaHocLucTieuHoc { get; set; }
}
