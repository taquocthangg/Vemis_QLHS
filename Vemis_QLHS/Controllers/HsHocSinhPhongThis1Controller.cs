...
namespace Vemis_QLHS.Controllers
{
    ...
    [ApiController]
    public class HsHocSinhPhongThis1Controller : ControllerBase
    {
        private readonly VemisStudentContext _context;

        public HsHocSinhPhongThis1Controller(VemisStudentContext context)
        {
            _context = context;
        }

        // GET: api/HsHocSinhPhongThis1
        [HttpGet]
        ...
        // DELETE: api/HsHocSinhPhongThis1/5
        [HttpDelete("{id}")]
